 ...
 */
class Segmento extends \App\Entities\Segmento implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\Segmento' . "\0" . 'id', '' . "\0" . 'App\\Entities\\Segmento' . "\0" . 'descricao'];
        }
