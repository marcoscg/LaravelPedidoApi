 ...
 */
class Operadora extends \App\Entities\Operadora implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\Operadora' . "\0" . 'id', '' . "\0" . 'App\\Entities\\Operadora' . "\0" . 'descricao', '' . "\0" . 'App\\Entities\\Operadora' . "\0" . 'imagem'];
        }
