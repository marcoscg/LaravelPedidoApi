...
class Contato extends \App\Entities\Contato implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\Contato' . "\0" . 'id', '' . "\0" . 'App\\Entities\\Contato' . "\0" . 'nome', '' . "\0" . 'App\\Entities\\Contato' . "\0" . 'cargo', 'cliente', 'fones', 'emails'];
        }
     ...
     * {@inheritDoc}
     */
    public function addFone(\App\Entities\ContatoFone $fone)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addFone', [$fone]);

        return parent::addFone($fone);
    }
     ...
     * {@inheritDoc}
     */
    public function addEmail(\App\Entities\ContatoEmail $email)
    {
